...
//			}
			...
			if ( isset( $config_array['form'] ) ) {
				$this->set_form( $config_array['form'] );
			}
		...
		public function hide_submit() {
			$this->hide_submit = true;
		}

		public function set_form( array $config_form ) {

			$default_form = array(
				'submit_label' => '',
				'id'           => $this->text_domain . '-form-id',
				'class'        => $this->text_domain . '-form-class',
			);

			$this->form_atts = wp_parse_args( $config_form, $default_form );
...
//                delete_option( $this->options_id);
            ...
            <div class="metabox-holder">
				...
				?>
                <form method="post" action="options.php" id="<?php echo $this->form_atts['id'] ?>"
                      class="<?php echo $this->form_atts['class'] ?>">
					<?php
...
//						do_settings_sections( $section['id'] );
                    ...
                    <div style="padding-left: 10px">
						<?php submit_button( $this->form_atts['submit_label'] ); ?>
                    </div>
